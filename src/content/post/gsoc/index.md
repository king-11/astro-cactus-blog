...
- gsoc
- tech
publishDate: 2021-07-05 13:18:46+05:30
coverImage:
  src: journey.webp
  alt: Journey Google Summer of Code
---

This post highlights my journey of getting selected into Google Summer of Code from the very beginning.

I believe that there is no defined path for getting selected in such open-source fellowships. Everyone has a unique journey, and you can take a few things from other journeys to write yours :) because the essence of each one is similar.
...
- The initial Pre GSoC, will cover how I came about making my first contribution in Open Source and developed my skills
- The later part GSoC InFocus, focuses on GSoC specific things like selecting an organization, contributing, writing a proposal, etc.
...
:::tip
This phase is crucial because your zeal and fire to contribute and make a mark in the open-source community starts to rage, and doing so fuels that fire further.
:::

### How I came to know about GSoC?

The first time I heard about GSoC was in an event conducted by [Club of Programmers](http://copsiitbhu.co.in/) where I was introduced to open-source programs like GSoC, Outreachy, etc. and people who were previously selected shared their experience with us.

![conference](https://media.giphy.com/media/JUXtbHuixcZKeGJEro/giphy.gif)

I wasn’t sure whether I would someday dwell into the realm of Open Source as, at that time, I was more focused on Competitive Programming like most of my peers.

Things changed after the programming camp in the Winter of 2019, where I started with Web Dev, and now I was sure I want to be amongst the group of people who clear GSoC.

Then came the GSoC’20. Many of my seniors who applied got selected, and I thought that a first-year student could never clear GSoC (that perception changed later), so I focused on improving my skills in Web Development and didn’t bother applying in 2020.
...
Apart from my own projects, I participated in projects of our Programming Club and also did an internship.

:::info
These things prepared me to swiftly walk through a large codebase, collaborate on Github, use version control, apply my knowledge, etc.
:::

### Open Source Hacktoberfest

>There couldn't be a better start for your open-source journey than [HacktoberFest](https://hacktoberfest.digitalocean.com/).

It’s an annual open-source event where project maintainers await your contributions, and they prepare their projects to accept new contributors.

Apart from contributing, you also used to rewarded swags, tees, etc. by DigitalOcean and some of the projects.

>You can check out [hacktoberfestswaglist](https://hacktoberfestswaglist.com/) during hacktoberfest to know about projects offering additional swags.

I outlined my hacktoberfest with my friend [Kushal](https://github.com/K-Kumar-01) ahead of October. We decided to go **good-first hunting**, work on several issues and earn some swags.

_Who doesn't like swags, right?_

All of the projects were very welcoming. Even though I had **no idea** about the tech stack they were using, I contributed to them, I focused on solving issues and for that I asked a lot of clarifying questions.
...
I started looking at GSoC archives in January and probably would have gone through the whole A-Z list about 10–20 times.

Earlier, they didn’t have filters for the tech stack, but they have it now, and it really helps to select the organization.

First, I jotted down the list of organizations I wanted to contribute to based on my **interest** in their **past** and current **projects** and those that didn’t require me to learn something completely new (biggest mistake).

It is hard to find a project where you have experience with all the technical tools. So in my experience it’s okay for you to select an organization where you have only know **40%** of the tech stack.
...
One of the most useful tools I found when selecting my GSoC organization was developed by one of my seniors [Nishant Mittal](https://github.com/nishantwrp), [GSOC Organizations](https://www.gsocorganizations.dev/). With all the statistics at hand, I can filter out organizations.
...
- **Number of people** already **contributing** to them because eventually only a few students will be selected for summer.
- Organizations using **IRC** as a means of communication were a big NO! for me.

In the end, I decided to go with [HTTP-APIs](https://github.com/HTTP-APIs).

I started checking out their **Contributing Guidelines**, **Getting Started Guides**, and their **code repository**. I selected HTTP-APIs because REST APIs are my **forte**, and they were doing something pretty interesting.
...
If you know me prior, you already know that I never went through with HTTP-APIs instead, it was [Chapel](https://chapel-lang.org/).
...
The thing with all GSoC organizations is that they had **excellent resources** for you to get started with. This includes documentation, contributing guidelines, getting started with contributions, etc.
...
My organization mentors seemed happy with the design, they didn't seem to have many questions around what I had written in the draft.
...
You can find mine and several other accepted proposals in this [repository](https://github.com/COPS-IITBHU/GSoC-Accepted-Proposals). Courtesy of [Club of Programmers IIT BHU](http://copsiitbhu.co.in/)
...
GSoC is a _non-competitive_ (after getting selected, of course 😏) program so try to cherish the community alongside it. Find your **motivation**, why do you even want to do it first, and the rest will follow.
...
:::important
It was a pivotal experience in my software engineering journey which moulded me for future.
:::

>2025: I learned a lot from my mentors and fellow GSoC mentees. I am still in contact with my mentor Michael. Since then I have also completed my projects with Linux Foundation Mentorship (2021) and Summer of Bitcoin (2023).
